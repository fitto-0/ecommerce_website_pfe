                ...
                <div class="col-md-6 py-4 px-5 d-flex flex-column gap-4">
                    <div>
                        <form action="" method="post" class="d-flex flex-column gap-4" enctype="multipart/form-data">
                            ...
                            <div class="form-outline">
                                <label for="user_image" class="form-label">Admin Image</label>
...
if (isset($_POST['admin_register'])) {
    ...
    $select_query = "SELECT * FROM `admin_table` WHERE username='$username' OR admin_email='$email'";
    ...
    if ($rows_count > 0) {
        ...
        $insert_query = "INSERT INTO `admin_table` (username,admin_email,user_image,admin_password) VALUES ('$username','$email','$image','$hash_password')";
